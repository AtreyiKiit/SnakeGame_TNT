...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.image = pygame.image.load("resources/food.jpg").convert()
        self.x = SIZE*3
        self.y = SIZE*3
...
class Game:
    def __init__(self):
        ...
        self.surface = pygame.display.set_mode((1250, 640))
    ...
    def play_sound(self, sound_name):
        if sound_name == "crash":
            sound = pygame.mixer.Sound("resources/Fail.mp3")
    ...
    def play(self):
        ...
        if not (0 <= self.snake.x[0] <= 1250 and 0 <= self.snake.y[0] <= 640):
            self.play_sound('crash')
